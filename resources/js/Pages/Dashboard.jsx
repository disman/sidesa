         ...
         <div className="py-12">
            ...
            <div className="p-4">
               {props.myNews && props.myNews.length > 0 ? props.myNews.map((news, i) => {
                  return (
                     <div key={i} className="card w-full bg-base-100 shadow-xl m-2 flex justify-center flex-col lg:flex-row lg:flex-wrap lg:items-stretch items-center">
                        <div className="card-body">
                           ...
                           <div className="card-actions justify-end">
                              ...
                              <div className="badge badge-inline">{news.author}</div>
                              <div className="badge badge-outline"><Link href={route('edit.news')} method="get" data={{ id: news.id }} as="button">Edit</Link></div>
                              <div className="badge badge-outline"><Link href={route('delete.news')} method="post" data={{ id: news.id }} as="button">Delete</Link></div>
                           </div>
                        </div>
                     </div>
                  )
